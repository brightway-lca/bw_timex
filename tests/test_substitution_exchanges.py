...
class TestClass_substitution:
    ...
    def test_substitution(self):
        ...
        expected_substitution_score = (1 + #direct emissions at A                                        (-5) * 1 + # direct emissions at B
                                    -5 * 1 * 0.5 * 0.8 + # emissions from D in 2028 from db_2030
                                    -5 * 1 * 0.5 * 0.2 + # emissions from D in 2028 from db_2020
                                    -5 * 1 * 2 * 0.8 + # emissions from E in 2028 from db_2030
                                    -5 * 1 * 2 * 0.2) # emissions from E in 2028 from db_2020
    
       
        assert self.tlca.static_score == expected_substitution_score
