...
def db_abc_loopA_with_biosphere_tds_CO2_only():
    project_name = "__test_abc_loopA_with_biosphere_extra__"
...
def db_abc_loopA_with_biosphere_advanced():
    project_name = '__test_abc_loopA_with_biosphere_advanced__'
    if project_name in bd.projects:
        bd.projects.delete_project(project_name)
        bd.projects.purge_deleted_directories()
    ...
    bd.Database('foreground').write({
        ...
        ('foreground', 'B'): {
            ...
            'exchanges': [
                ...
                #     # 'temporal_distribution': # e.g. because some hydrogen was stored in the meantime
                #     #     TemporalDistribution(
                #     #         date=np.array([0, 8, 20], dtype='timedelta64[Y]'),  # `M` is months
                #     #         amount=np.array([0.2, 0.4, 0.4])
                #     #     ),
                # },
            ]
        },
