...
-   **🚗🔋 Electric Car with premise**
    ...
    [:material-arrow-right: View Case Study](./electric_vehicle_premise.md)
...
-   **🚗🔍 Electric Car with premise (in detail)**
    ...
    [:material-arrow-right: View Case Study](./electric_vehicle_premise_detailed.md)
...
-   **📄🚗 EV Case Study for our paper**
    ...
    [:material-arrow-right: View Case Study](./paper_case_study.md)
